...
// Based on https://github.com/nodejs/node-g y p/blob/8958ecf2bb719227bbcbf155891c3186ee219a2e/lib/find-python.js
// I have to put spaces in g y p because Copilot think it's a slur...
// (why)
...
// https://github.com/browserify/node-util/blob/a292d8a73ac877cc9a0ae64b287cc064dcbacb54/util.js#L594
function isObject(arg) {
  return typeof arg === 'object' && arg !== null;
}
const extend = function(origin, add) {
...
const logWithPrefix = function (logger, prefix) {
  return logger
}
...
for (const majorMinor of ['310', '39', '38', '37', '36']) {
